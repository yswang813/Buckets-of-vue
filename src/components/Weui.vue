<template>
  <div>
    ...
    <h1>Weui is a UI library from WeChat.</h1>
    <h2>emotion:</h2>
    <emotion v-for="src in list">{{src}}</emotion>
    <br>

    <h2>gif:</h2>
    <emotion is-gif v-for="src in list">{{src}}</emotion>
  </div>
</template>

<script>
import { XHeader,WechatEmotion as Emotion } from 'vux'
